...
(function () {
  ...
  function recommend(a) {
    ...
    if (a.use === 'renovate')    return { name: 'Leap Revive',  desc: 'Built for the homeowner who wants to renovate the home they already love, with all funds available at close.', href: 'https://app-stage.leaphei.com/' };
    if (a.use === 'retirement')  return { name: 'Leap Relax',   desc: 'Engineered for homeowners approaching retirement who want to turn equity into a longer runway.', href: 'https://app-stage.leaphei.com/' };
    return { name: 'A Leap HEI', desc: 'A licensed Leap specialist will match you to the right product for your situation in a 15-minute conversation.', href: 'https://app-stage.leaphei.com/' };
  }
